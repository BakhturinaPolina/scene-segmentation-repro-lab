...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--base_dir",
        type=Path,
        default=Path("outputs/review/excel/prompting_familyB_reasoning-off"),
    ...
    parser.add_argument(
        "--out_csv",
        type=Path,
        default=Path("outputs/review/excel/prompting_familyB_reasoning-off/top_fp_review_table.csv"),
        help="Output CSV path.",
    )
    parser.add_argument(
        "--out_json",
        type=Path,
        default=Path("outputs/review/excel/prompting_familyB_reasoning-off/top_fp_review_table.json"),
