...
Also writes a manifest (same top-level shape as data/manifests/stss_test_2.json):
...
DEFAULT_EXCEL_FILES = [
    Path("data/raw/excel/Gaensemagd_sentence level.xlsx"),
    Path("data/raw/excel/Kleist_sentence level.xlsx"),
]
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--manifest_out",
        type=Path,
        default=Path("data/manifests/excel_prompting.json"),
