...
``src/run_prompting_stratified.py``) and tags each FP/FN with one of the
...
Run from project root, pointing at the per-(model, family) output dir::
    ...
    python src/error_tag_review.py \
        --review_dir outputs/prompting/2026-05-15-phaseC-baselineB-full/strat_nvidia_nemotron-3-super-120b-a12b_free_familyB_reasoning-low \
        --tolerance 3
"""
