...
python src/review/render_review.py \
    --mode all \
    --xmi_dir outputs/runs/ssc/2026-04-05/baseline_bert/stss_test_2 \
    --standoff_dir upstream/scene-segmentation/data/standoff/stss_test_2 \
    --results_json outputs/runs/prompting/2026-04-05/baseline_qwen3/results.json \
    --out_dir outputs/review/markdown

# With English translation (outputs to outputs/review/markdown/en/):
python src/review/render_review.py --mode all ... --translate

# Individual modes:
python src/review/render_review.py --mode ground_truth \
    --xmi_dir ... --standoff_dir ... --out_dir ...
python src/review/render_review.py --mode ssc \
    --xmi_dir ... --out_dir ...
python src/review/render_review.py --mode prompting \
...
def main():
    ...
    parser.add_argument(
        "--out_dir",
        type=Path,
        default=Path("outputs/review/markdown"),
        help="Output directory for Markdown files (default: outputs/review/markdown).",
    )
    parser.add_argument(
        "--snippet_chars",
        type=int,
