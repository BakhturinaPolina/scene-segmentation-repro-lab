...
Date: 2026-05-16
Track: prompting
Scope: §5.2 of [docs/planning/PROJECT_PLAN.md](../planning/PROJECT_PLAN.md)
Source Paper: [Zehe, Fischer, and Hotho, 2025 (NAACL Long Paper 500)](../reference/2025.naacl-long.500.pdf) and do not work with the code.
...
Our §5.2 protocol is defined in [docs/planning/PROJECT_PLAN.md](../planning/PROJECT_PLAN.md) lines 210–319 and was executed end-to-end on 2026-05-15 (see [sync note](../../research_log/sync_notes/sync__2026-05-15__stss2-section52-campaign.md)). The three-phase structure was kept deliberately conservative — one factor changes between adjacent rows, low-performers are dropped before the next phase, and the headline number only comes from a "full" run on 892 sentences.
...
- [docs/reference/2025.naacl-long.500.pdf](../reference/2025.naacl-long.500.pdf) — Zehe et al., "Assessing the State of the Art in Scene Segmentation", NAACL 2025 long paper 500. Relevant: §4.2, §6.3, §7.2, Table 1, Table 2, Appendix A.2.
