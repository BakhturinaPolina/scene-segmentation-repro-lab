...
- The old Phase A manifest at `outputs/runs/prompting/2026-04-09/phase_a_manifest.json` reflects pre-fix failures (`reasoning=off`) and should not be used as current performance evidence.
...
- `outputs/runs/prompting/2026-04-09-i-rerun/strat_openrouter_free_familyI_reasoning-low/summary.json`
- `outputs/runs/prompting/2026-04-09-h-rerun/strat_openrouter_free_familyH_reasoning-low/summary.json`
- `outputs/runs/prompting/2026-04-09/phase_a_manifest.json` (historical failure manifest)
